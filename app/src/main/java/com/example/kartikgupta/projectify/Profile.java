...
public class Profile extends Activity implements View.OnClickListener{
    ...
    private EditText editTextUsername, editTextSkill, editTextInterest, editTextPassword, editTextExperience, editTextDesignation, editTextMoreInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextUsername = findViewById(R.id.editTextEmailInput);
